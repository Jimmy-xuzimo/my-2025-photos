...
function showCurrentPhoto() {
    ...
    // 确保设备信息正确显示
    const deviceText = `Shot By ${photo.device}`;
    elements.photoDevice.textContent = deviceText;
    console.log(`Device text set to: ${deviceText}`);
    console.log(`Photo device element:`, elements.photoDevice);
    console.log(`Photo device element content:`, elements.photoDevice.textContent);
}
